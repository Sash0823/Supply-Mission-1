...
helicopter = Bodies.triangle(100,250,70,helicopter_options);
...
rectMode(CENTER);
rect(helicopter.position.x,helicopter.position.y,400)
  //display ball 
  ellipseMode(RADIUS);
  ellipse(ball.position.x, ball.position.y,20,20);

  ellipseMode(RADIUS);
  ellipse(helicopter.position.x, helicopter.positiom.y,20,20);
